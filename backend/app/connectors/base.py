...
class TimeEntryNormalized(BaseModel):
    ...
    duration_sec: int = Field(..., ge=0, description="Duration of the time entry in seconds")
    activity_type_id: Optional[int] = Field(None, description="ID of the activity type")
    customer_id: Optional[int] = Field(None, description="Kimai customer ID")
    project_id: Optional[int] = Field(None, description="Kimai project ID")
    activity_id: Optional[int] = Field(None, description="Kimai activity ID")
